...
@if($this->hiddenId)
<h3 class=" inline-block mb-2 text-lg font-medium text-gray-900">Editing category: {{$category_name}}</h3>
@else
<h3 class=" inline-block mb-2 text-lg font-medium text-gray-900">Enter category</h3>
@endif
        <input class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm mt-1 block w-full"  type="text"  wire:model="category_name">
        @error('category_name')
    ...
    <div class="col-span-6 sm:col-span-4">
        ...
        <div class="">
            <div class="mb-3 ">
                <h3 class=" inline-block mb-2 text-lg font-medium text-gray-900">Enter Category Description</h3>
              <textarea
                class="
                  form-control
                  block
...
<!-- Livewire Component wire-end:ZTEDxWwbYX1S03SRLWt1 -->        </div>
            ...
            <div class="sm:px-6 w-full">
                <div class="bg-white py-4 md:py-7 px-4 md:px-8 xl:px-10">
                    ...
                    <div class="p-2">
                        <button type="button" class="inline-block px-6 py-2.5 bg-green-500 text-white font-medium text-xs leading-tight uppercase rounded-full shadow-md hover:bg-green-600 hover:shadow-lg focus:bg-green-600 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-green-700 active:shadow-lg transition duration-150 ease-in-out"wire:click="addCategory()">Add new Category</button>
                    </div>
                </div>
