                                               ...
                                               <div class="mt-5 md:mt-0 md:col-span-2">
                                                  <form wire:submit.prevent="save">
                                                             ...
                                                             <div class="px-4 py-5 bg-white sm:p-6 shadow sm:rounded-tl-md sm:rounded-tr-md">
                                                                ...
                                                                <div class="col-span-6 sm:col-span-4">
                                                                            <label class="block font-medium text-sm text-gray-700" for="name">Owner Name</label>
                                                                            <input class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm mt-1 block w-full" id="name" type="text" wire:model.defer="administrator.name">
                                                                 </div>
                                                                    <div class="col-span-6 sm:col-span-4">
                                                                         <label class="block font-medium text-sm text-gray-700" for="name">
                                                                         Owner Email</label>
                                                                             <input class="border-gray-300 focus:border-indigo-300 focus:ring        focus:ring-indigo-200   focus:ring-opacity-50 rounded-md shadow-sm mt-1 block w-full" id="name" type="text" wire:model.defer="administrator.email">
                                                                     </div>
                                                                     ...
                                                                     @else
                                                                      ...
                                                                      @endif
                                                                         <input class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm mt-1 block w-full"  type="text"  placeholder="Name of Sportcenter" wire:model="name">
                                                                                  @error('name')
                                                         ...
                                                         <div class="col-span-6 sm:col-span-4">
                                                                 <input class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm mt-1 block w-full"  type="text" placeholder="Location"  wire:model="location">
                                                             </div>
                                                            ...
                                                            <div class="col-span-6 sm:col-span-4">
                                                                <select
                                                                            ...
                                                                            ease-in-out
                                                                            m-0
                                                                            focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" aria-label="Default select example" wire:model="district">          
                                                          ...
                                                          <div class="col-span-6 sm:col-span-4">
                                                                 <select
                                                                   class="form-select appearance-none
                                                                                ...
                                                                                ease-in-out
                                                                                m-0
                                                                                focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"aria-label="Default select example" wire:model="area_id">
                                                             ...
                                                             <div class="col-span-6 sm:col-span-4 ">
                                                                                         ...
                                                                                         <textarea
                                                                                                ...
                                                                                                ease-in-out
                                                                                                m-0
                                                                                                focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"                             rows="2"
                                                                  ...
                                                                  <div class="col-span-6 sm:col-span-4">
                                                                        <div class="form-check inline">
                                                                              <h2 class="text-gray-1000 text-xl">Choose Logo</h2>

                                                                               @if(false)
                                                                                    <img src="{{ asset('storage/' . $image) }}" alt="" class=" w-50">
                                                                                  @else
                                                                ...
                                                                <div class="col-span-6 sm:col-span-4">
                                                                                  ...
                                                                                  <select class="form-select appearance-none
                                                                                                        ...
                                                                                                        m-0
                                                                                                        focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                                                                                                         aria-label="Default select example"  wire:model="arena_category_id">
